...
void AirsimROSWrapper::rpy_thrust_cmd_cb(const mavros_msgs::AttitudeTarget &attitude_cmd_msg)
{
    ...
    if (isENU_)
    {
        ...
        double thrust = attitude_cmd_msg.thrust;
        static_cast<msr::airlib::MultirotorRpcLibClient *>(airsim_client_.get())->moveByAngleRatesThrottleAsync(attitude_cmd_msg.body_rate.x, -attitude_cmd_msg.body_rate.y, -attitude_cmd_msg.body_rate.z, thrust, 0.01);
    ...
    else
    {
        ...
        static_cast<msr::airlib::MultirotorRpcLibClient *>(airsim_client_.get())->moveByAngleRatesThrottleAsync(attitude_cmd_msg.body_rate.x, attitude_cmd_msg.body_rate.y, attitude_cmd_msg.body_rate.z, attitude_cmd_msg.thrust, 0.01);
    }
    return; // hzchzchzc
}
// todo support multiple gimbal commands
